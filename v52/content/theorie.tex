...
\begin{figure}[H]
    ...
    \caption{Verlustfreie und verlustbehaftete Schaltung.\cite{Durchfuhrung}}
    \label{fig:Schaltung}
\end{figure}
...
Des Weiteren ist zu beachten, dass es bei hohen Frequenzen $\omega \leq \qty{100}{\kilo\hertz}$ zu dem sogenanntem Skin-Effekt kommt, welcher beschreibt, dass die im Inneren des Leiters aufgebauten B-Felder periodisch ihre Richtung ändern, dadurch Wirbelströme erzeugen, welche den Wechselstrom im Leiterinneren zur Leiteroberfläche drückt.
...
Der räuumliche Verlauf von der reflektierten Welle $U_r(z,t)$ ist darstellbar durch die Laplace-Transformation der einlaufenden Welle $U_h(p)$ und des Reflexionskoeffizienten $\Sigma(p)$ in Impulsebene mit 
\begin{equation*}
U_{r}(t) = \mathcal{L}^{-1}\{U_{r}(p)\} = \mathcal{L}^{-1}\{\Gamma(p) \cdot U_{h}(p)\}.
\end{equation*}

Mithilfe eines Impulsfahrplans können Spannugnsänderungen den Störstellen zugeordnet werden. Ein beispielhafter Impulsfahrplan wird in folgender Abbildung dargestellt.
\begin{figure}[H]
    \centering
...
In der folgenden Abbildung ist zu sehen, wie der zeitliche Verlauf einer überlagerten Signalspannung am Oszilloskop aussieht.
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{content/pics/Überlagerung.png}
    \caption{Zeitlicher Verlauf der Signalspannung an einem Punkt $z$ am Oszilloskop.\cite{Durchfuhrung}}
