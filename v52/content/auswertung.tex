...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.32\textwidth}
        ...
        \label{fig:kabel3}
    \end{subfigure}
    \caption{Oszillogramme der drei Koaxialkabel. V.l.n.R. Kabel 1, Kabel 2 und Kabel3. Die Eingangs- und Reflexionspeaks sowie die Zeitdifferenz $\Delta t$ sind zu erkennen.}
